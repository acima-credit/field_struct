...
RSpec.describe FieldStruct::MutableExamples::User do
  describe 'class' do
    ...
    context '.json_schema' do
      let(:exp_hsh) do
        {
          '$id' => 'https://schema-store.example.com/field_struct.mutable_examples.user/2359756858.json',
          '$schema' => 'http://json-schema.org/draft-07/schema#',
          'description' => 'JSON Schema for FieldStruct::MutableExamples::User version 2359756858',
          'type' => 'object',
          'properties' => {
      ...
      it { expect(subject.name).to eq 'field_struct.mutable_examples.user' }
