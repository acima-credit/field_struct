...
require 'fielded_struct/version'

Gem::Specification.new do |spec|
  spec.name = 'fielded_struct'
  ...
  if current_branch == 'master'
    spec.version = FieldedStruct::VERSION
  else
    spec.version = "#{FieldedStruct::VERSION}-#{branch_commit}"
  end

  spec.summary = 'A simple struct with typed attributes'
  spec.description = 'A simple struct with typed attributes'
  spec.homepage = 'http://github.com/acimacredit/fielded_struct'
  spec.license = 'MIT'
